...
Чтобы развернуть проект локально, следуйте инструкциям в каждой из трёх директорий сервисов. Чтобы запустить проект в контейнерах, следуйте инструкци ниже.<br>

Запустите Docker Desktop.<br>
Сборка проекта:
```
